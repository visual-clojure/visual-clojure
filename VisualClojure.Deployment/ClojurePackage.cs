...
using VisualClojure.Debugger;
using VisualClojure.Deployment.Configuration;
using VisualClojure.Editor.Commenting;
using VisualClojure.Editor.TextBuffer;
using VisualClojure.Parsing;
using VisualClojure.Project.Launching;
using VisualClojure.Repl;
using VisualClojure.Repl.Operations;
using VisualClojure.Utilities;
using VisualClojure.Utilities.IO.Compression;
using EnvDTE;
using EnvDTE80;
using VisualClojure.Editor;
using VisualClojure.Editor.AutoFormat;
using VisualClojure.Editor.Options;
using VisualClojure.Project;
using VisualClojure.Project.Hierarchy;
...
using clojure.lang;
using vsClojure;
using Constants = VisualClojure.Utilities.Constants;
using Process = System.Diagnostics.Process;
using VisualClojure.Editor.Intellisense;
    ...
    public sealed class ClojurePackage : ProjectPackage
    {
        ...
        private void EnableSettingOfRuntimePathForNewClojureProjectsOnFirstInstall()
        {
            ...
            if (firstInstall)
            {
                ...
                //TODO: Replace with file search
                var pathToReadme = string.Format(@"{0}\README.md", deployDirectory);
